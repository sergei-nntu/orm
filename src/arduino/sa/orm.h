...
const short orm_j_stepper_full_rot[JOINTS_COUNT] = {16000, 16000, 9780};  // Number of steps to reach 2*Pi Angle
...
class ORM {
  private:
    ...
    short j_angle_desired[JOINTS_COUNT] =   {0, 0, 0};
    short j_angle_current[JOINTS_COUNT] =   {0, 0, 0};
    short j_angle_read[JOINTS_COUNT] =      {0, 0, 0};
    short j_angle_correction[JOINTS_COUNT] ={0, 0, 0};

    // STATISTICAL FILTERING 

    short j_angle_sample[JOINTS_COUNT * STAT_SAMPLE_SIZE];

    int read_samples_size[JOINTS_COUNT] = {0,0,0};
    int read_samples_ptr[JOINTS_COUNT] = {0,0,0};
    /*
